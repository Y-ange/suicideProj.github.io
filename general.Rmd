...
We are also interested about the ranking of amount of suicides across the time. Below, we show the changing of the ranking across the time. Since there are too many, we will choose the top 20 countries with most total amount of suicide from 1985 to 2015. Each of them has more than 10k death due to suicide across this 30-year period. Those countries are:
