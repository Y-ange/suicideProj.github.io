...
The main dataset for our project is a combined dataset from summary datasets made by United Nations Development Program, World Bank, Kaggle, and World Health Organization. It can be access at [here](https://www.kaggle.com/russellyates88/suicide-rates-overview-1985-to-2016). For our purpose, regression analysis will be the main method. Details about the analysis can be found in the section of **Regression Analysis** section.
...
- Yeqing Ji
- Yingxi Ji
- Yiling Yang | [yy3018@columbia.edu](yy3018@columbia.edu)
- Wurongyan Zhang
