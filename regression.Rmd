...
There are average `r mean(country_count$count)` countries in the dataset across each year. Graph below shows the distribution. Although there are less countries before 1995, the amount of countries for each year is stable arount 80.
